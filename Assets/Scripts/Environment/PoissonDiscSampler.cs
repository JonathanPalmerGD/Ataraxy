...
{
	private int k = 20;  // Maximum number of attempts before marking a sample as inactive.
	...
	public PoissonDiscSampler(float width, float height, float radius, int inputK)
	{
		k = inputK;
